...
const menuItems: MenuItemCfg[] = [
  ...
  { key: "14", page: "api-reference", label: "API 参考", icon: <ApiOutlined style={{ fontSize: 18 }} /> },
  {
    key: "16",
  ...
  { key: "15", page: "logs", label: "日志", icon: <LineChartOutlined style={{ fontSize: 18 }} /> },
  {
    key: "11",
    page: "guardrails",
    label: "护栏",
  ...
  },
  {
    ...
    children: [
      { key: "18", page: "mcp-servers", label: "MCP 服务器", icon: <ToolOutlined style={{ fontSize: 18 }} /> },
      {
        key: "21",
        page: "vector-stores",
        label: "向量存储",
